...
const Headers = () => {
    return (
        <header className="w-full bg-white border-b border-gray-100 sticky top-0 z-50">
            ...
            {/* --- TOP BAR --- */}
            <div className="hidden sm:flex items-center justify-between px-5 lg:px-12 py-2 border-b border-gray-100">
            ...
            {/* --- MAIN HEADER --- */}
            <div className="container mx-auto px-4 sm:px-5 lg:px-8 h-17 flex items-center justify-between">
