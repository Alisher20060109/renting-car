...
const Home = () => {
  return (
    <main>
      ...
      <section className="relative bg-linear-to-r from-purple-600 to-indigo-600 rounded-2xl py-16   text-center text-white overflow-hidden">
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between gap-12 py-12 md:py-16 px-6 md:px-10 overflow-hidden">
